...
export type ScreenType = 'home' | 'study' | 'manage';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const tabs = [
    ...
    { key: 'study' as ScreenType, name: t.tabStudy || 'ฝึกคำศัพท์', icon: BookOpen },
    { key: 'manage' as ScreenType, name: t.tabManage || 'จัดการการ์ด', icon: Settings }
  ];
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex-1 flex flex-col items-center gap-1 py-1.5 px-2 rounded-xl transition-all cursor-pointer active-push"
            >
